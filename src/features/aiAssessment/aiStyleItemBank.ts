...
// The first six items of every axis form the 24-item scored Beta short form.
export const usageStyleCandidateItems: UsageStyleCandidateItem[] = [
  ...
  item('ES07', 'explore', 'first', '我愿意固定留出时间，专门探索还没有明确用途的 AI 新能力。'),
  item('ES08', 'explore', 'second', '只有看到新方法在真实任务中明显更好，我才会调整现有工具组合。'),
  ...
  item('CO07', 'create', 'first', '面对一张白纸构思 AI 可以创造什么，通常比修补现有流程更吸引我。'),
  item('CO08', 'create', 'second', '减少错误、等待和交接成本，会比做出一个新概念更让我有成就感。'),
  ...
  item('RA07', 'reason', 'first', '采用一种 AI 方法前，我更愿意先理解它依赖的假设和适用边界。'),
  item('RA08', 'reason', 'second', '我通常先做出一个能运行的版本，再逐步建立对背后方法的理解。'),
  ...
  item('PD07', 'partner', 'first', '我更喜欢和 AI 一起查看中间产物，边做边共同决定下一步。'),
  item('PD08', 'partner', 'second', '规则成熟后，我更喜欢只看最终结果、日志和异常，而不是每一步都参与。'),
