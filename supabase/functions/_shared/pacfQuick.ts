...
export const PACF_QUICK_INSTRUMENT = {
  id: "pacf-quick-v1-candidate",
  frameworkVersion: "pacf-1.0.0",
  itemBankVersion: "pacf-item-bank-1.0.0",
  scoringVersion: "pacf-scoring-1.0.0",
  title: "个人 AI 能力快速筛查 v1",
...
export function scorePACFQuick(value: unknown) {
  ...
  const competencyScores = Object.fromEntries(itemScores.map((item) => [item.competencyId, item.normalizedScore]));
