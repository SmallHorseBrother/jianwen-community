...
begin
  ...
  values (
    ...
    '在科研之外，我长期深度投入健身训练、自媒体内容创作和创业实践。过去几年里，我一边做学术研究，一边围绕健康管理、运动学习和 AI 原生工具搭建自己的产品体系。目前核心在推进食探和教链两个小程序方向，并把 Pull-up Index 等训练评估工具融入教链，尝试用 AI 提升大众健康管理效率，以及提升教练服务的数字化程度。'||E'\n\n'||
  ...
  (
    ...
    null,
    true,
    '一个围绕 AI 食物识别、营养估算和日常饮食记录的小程序产品，尝试把健康饮食从抽象建议变成可执行的数据反馈。',
    '食探目前通过 Healthy Max 宣传页对外展示，核心关注拍照识别食物、估算热量与营养、辅助用户完成饮食记录和健身管理。这个方向从“大而全”的健康平台思路逐渐收敛到“先把饮食识别和记录这件事做扎实”的路线。',
    array[
      'AI 拍照食物定量识别',
      '多模态大模型能力',
      '饮食记录与营养估算',
    ...
    jsonb_build_array(
      jsonb_build_object('label', '查看食探宣传页', 'url', 'https://healthymax.cn/')
    ),
    7,
    true
  ),
  (
    ...
    null,
    true,
    '一个帮助线上健身教练提升效率、规范学员管理、沉淀训练数据和反馈流程的小程序与网页版平台。',
    '教链的核心目标是替代微信等低效教学工作流，为教练与学员建立专业、高效、可持续复用的数字化协作环境。平台围绕计划模板化、学员管理可视化、视频点评精准化、训练任务清晰化和训练评估工具展开，未来会继续叠加 AI 制定计划与知识库能力。',
    array[
      '教练端效率工具',
      '学员数据与任务可视化',
      'Pull-up Index 训练评估能力',
      'AI 计划生成潜力',
      '线上教学工作流重构'
    ]::text[],
    jsonb_build_array(
      jsonb_build_object('label', '访问教链网页版', 'url', 'https://coachlink.fit/')
    ),
    8,
    true
  ),
  (
    ...
    null,
    true,
    '一个围绕引体向上指数、1RM 估算和训练数据评估的小工具，现在已经融入教链，成为训练评估能力的一部分。',
    'Pull-up Index 最初是独立的单杠训练数据工具，用于帮助用户用更直观的方式理解引体表现、力量水平和训练进展。随着教链推进，它不再作为分散产品重点宣传，而是被纳入教链的训练评估和教练服务场景。',
    array[
      '引体向上指数',
      '1RM 估算',
      '训练评估',
    ...
    jsonb_build_array(
      jsonb_build_object('label', '查看 Pull-up Index', 'url', 'https://pullupindex.top/')
    ),
    9,
    true
  ),
